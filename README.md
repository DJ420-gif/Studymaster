...
<body class="bg-light text-dark">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item theme-toggle-btn"><i class="fas fa-moon"></i></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <header class="bg-light text-center py-5">
        <div class="container">
            <h1>Welcome to Class 10 Study Hub</h1>
            <p>Your one-stop destination for study materials, notes, and solutions!</p>
